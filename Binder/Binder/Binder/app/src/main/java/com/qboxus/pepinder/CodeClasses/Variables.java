...
public class Variables {
    ...
    public static String gif_api_key1="mCtVDZvDDSiICqOQE8qZM1VRhbYCwz9H";
    ...
    public final static int Select_image_from_gallry_code=3;
     ...
     public static String domain="http://167.99.2.243/api/index.php?p=";
     public final static String image_base_url="http://167.99.2.243/api/";

    // public static final String TWILIO_ACCESS_TOKEN_SERVER = "twilio_access_token_here";
    public static final String TWILIO_ACCESS_TOKEN_SERVER ="https://some_domain.twil.io/video-Token?identity=";
